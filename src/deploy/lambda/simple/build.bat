@echo off
REM Build script for PipeCD Tutorial Lambda Function (Windows)
REM This script packages the Lambda function code into a zip file

echo Building PipeCD Tutorial Lambda Function...

REM Set variables
set BUILD_DIR=build
set FUNCTION_NAME=pipecd-tutorial-simple
